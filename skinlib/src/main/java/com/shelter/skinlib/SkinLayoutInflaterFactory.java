...
/**
 * @author: Shelter
 * Create time: 2022/4/28, 23:03.
 */
public class SkinLayoutInflaterFactory implements LayoutInflater.Factory2, LayoutInflater.Factory, Observer {
    ...
    private View createSDKView(String name, Context context, AttributeSet
        ...
        Log.d("Shelter", "SkinLayoutInflaterFactory createSDKView() name = " + name);
        if (-1 != name.indexOf('.')) {
            return null;
        }
