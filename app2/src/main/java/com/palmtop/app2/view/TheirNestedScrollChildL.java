...
public class TheirNestedScrollChildL extends LinearLayout implements NestedScrollingChild {

    private static String Tag = "Zero";

    private NestedScrollingChildHelper helper;

    public TheirNestedScrollChildL(Context context) {
        super(context);
        init(context);
    }

    public TheirNestedScrollChildL(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public TheirNestedScrollChildL(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public TheirNestedScrollChildL(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
