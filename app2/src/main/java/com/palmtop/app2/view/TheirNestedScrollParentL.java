...
public class TheirNestedScrollParentL extends LinearLayout implements NestedScrollingParent {

    private static String Tag = "Zero";

    private NestedScrollingParentHelper helper;

    public TheirNestedScrollParentL(Context context) {
        super(context);
        init(context);
    }

    public TheirNestedScrollParentL(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public TheirNestedScrollParentL(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public TheirNestedScrollParentL(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
